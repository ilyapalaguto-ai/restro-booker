...
## Содержание
- [1. Что мы запускаем](#1-что-мы-запускаем)
- [2. Установка базовых инструментов](#2-установка-базовых-инструментов)
- [3. Клонирование репозитория](#3-клонирование-репозитория)
- [4. Запуск через Docker (рекомендуемый путь)](#4-запуск-через-docker-рекомендуемый-путь)
- [5. Файл окружения](#5-файл-окружения)
- [6. Создание первого пользователя (регистрация)](#6-создание-первого-пользователя-регистрация)
- [7. Структура проекта (кратко)](#7-структура-проекта-кратко)
- [8. Альтернативный ручной запуск без Docker](#8-альтернативный-ручной-запуск-без-docker)
- [9. Частые команды](#9-частые-команды)
- [10. Траблшутинг](#10-траблшутинг)
- [11. Обновление зависимостей](#11-обновление-зависимостей)
- [12. Расширения (если без DevContainer)](#12-расширения-если-без-devcontainer)
- [13. Следующие шаги для развития](#13-следующие-шаги-для-развития)
